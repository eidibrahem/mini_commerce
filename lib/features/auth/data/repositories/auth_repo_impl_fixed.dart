...
class AuthRepoImpl implements AuthRepo {
  ...
  Future<Result<UserEntity>> signInWithEmail(
    ...
    try {
      ...
      return FailureResult(
        failures.UnknownFailure('Failed to sign in with email'),
      );
    }
  }
  ...
  Future<Result<UserEntity>> signInWithGoogle() async {
    try {
      ...
      return FailureResult(
        failures.UnknownFailure('Failed to sign in with Google'),
      );
    }
  }
  ...
  Future<Result<UserEntity?>> getCurrentUser() async {
    try {
      ...
      return FailureResult(
        failures.UnknownFailure('Failed to get current user'),
      );
    }
  }
  ...
  Future<Result<void>> sendPasswordResetEmail(String email) async {
    try {
      ...
      return FailureResult(
        failures.UnknownFailure('Failed to send password reset email'),
      );
    }
  }
